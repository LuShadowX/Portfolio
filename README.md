...
👉 **[View Portfolio Live](https://lushadowx.github.io/Portfolio/)** 👈
...
* **Clean UI/UX:** A minimalist approach to keep the focus on content.
* **Fast Loading:** Optimized for performance with lightweight assets.

## 🛠️ Tech Stack

This project works with the fundamental building blocks of the web:
